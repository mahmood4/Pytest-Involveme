...
class TestForgotPassword(BaseTest):
   ...
   # @pytest.mark.skip
    def test_invalid_email(self):
        ...
        expected_success_msg = self.json_reader.read_from_json()["forgot_password"]["success_message"]
        assert_that(expected_success_msg).is_equal_to(self.pages['forgot_password_page'].get_invalid_email_msg())
    ...
    def test_expected_exception_on_page_title(self):
       ...
       # with pytest.raises(AssertionError) as e:
        assert self.pages['forgot_password_page'].get_page_title() == "Reset Password | involve.me"
