    ...
    env_parser.write_to_allure_env(
        {
           ...
           # "Commit_Author_Name": repo.base.head.commit.author.name,
           # "Branch": repo.base.Head.commit.active_branch.name
        })
...
######### pytest  -v -s --capture sys -rP  --alluredir=allure-results/ --browser  firefox
######### pytest  -v -s --capture sys -rP  --alluredir=allure-results/ --browser  chrome
